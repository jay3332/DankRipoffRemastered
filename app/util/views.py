...
class OwnerBypassButton(discord.ui.Button['UserView']):
    ...
    async def callback(self, interaction: TypedInteraction) -> None:
        self.view._UserView__owner_bypass = True
