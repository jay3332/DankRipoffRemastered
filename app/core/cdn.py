...
from typing import Any, BinaryIO, Final, NamedTuple, TYPE_CHECKING
...
class CDNClient:
    ...
    async def safe_upload(self, fp: BinaryIO, extension: str = None, *, directory: str = None, max_tries: int = 3) -> CDNEntry:
        ...
        for _ in range(max_tries):
            ...
            try:
                return await self.upload(fp, filename, directory=directory, raise_on_conflict=True)
